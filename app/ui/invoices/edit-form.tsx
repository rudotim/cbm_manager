      ...
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            {/* hidden input preserves customerId on form submit */}
            <input
              type="hidden"
              name="customerId"
            ...
            <div
              id="customer"
              className="peer flex items-center w-full rounded-md border border-gray-200 bg-white py-2 pl-10 pr-3 text-sm text-gray-700"
            >
